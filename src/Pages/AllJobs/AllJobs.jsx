  ...
  return (
    <div className="">
      ...
      <div className="overflow-x-auto max-w-7xl mx-auto">
        <form className="flex justify-end my-5 md:mr-10 items-center relative">
          <input
            className="flex h-10 md:w-4/12 rounded-md bg-gray-100 px-3 py-2 pr-10 text-sm placeholder:text-gray-600 focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
            type="text"
